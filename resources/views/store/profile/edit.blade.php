            ...
            <div class="space-y-6">
                <div class="card p-6">
                    <div class="text-center">
                        ...
                        @else
                            <div class="w-32 h-32 bg-tumbloo-gray-light rounded-full mx-auto mb-4 flex items-center justify-center">
                                <svg class="w-16 h-16 text-tumbloo-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24">

                            ...
                            <div class="filter-option">
                                <label>
                                    <input type="checkbox" name="season[]" value="summer" 
                                        {{ in_array('summer', request('season', [])) ? 'checked' : '' }}>
                                    Summer
                                </label>
                            </div>
                            <div class="filter-option">
                                <label>
                                    <input type="checkbox" name="season[]" value="winter" 
                                        {{ in_array('winter', request('season', [])) ? 'checked' : '' }}>
                                    Winter
                                </label>
                            </div>
                            <div class="filter-option">
                                <label>
                                    <input type="checkbox" name="season[]" value="spring" 
                                        {{ in_array('spring', request('season', [])) ? 'checked' : '' }}>
                                    Spring
                                </label>
                            </div>
                            <div class="filter-option">
                                <label>
                                    <input type="checkbox" name="season[]" value="fall" 
                                        {{ in_array('fall', request('season', [])) ? 'checked' : '' }}>
                                    Fall
                                </label>
                            </div>
                        </div>
                ...
                <div class="products-content">
                    ...
                    <div class="products-grid">
                        ...
                        <a href="{{ route('products.show', $product) }}" class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-actions">
                                    <button class="btn btn-primary btn-cart" onclick="event.preventDefault(); addToCart({{ $product->id }})">
                                        Add to Cart
                                    </button>
                                </div>
                            </div>
                        ...
                        <div style="grid-column: 1/-1; text-align: center; padding: 60px 0;">
                            ...
                            <p style="color: var(--color-secondary); margin-top: 10px;">Try adjusting your filters</p>
                        </div>
                        @endforelse
                    </div>

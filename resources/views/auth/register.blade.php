    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-tumbloo-gray">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-tumbloo-offwhite hover:text-tumbloo-accent-light font-medium transition">
                    Masuk di sini
                </a>
            </p>
        </div>
                ...
                <div class="mb-6">
                    <label class="flex items-start">
                        <input 
                            ...
                            name="terms"
                            required
                            class="w-4 h-4 mt-1 bg-tumbloo-dark border-tumbloo-accent rounded text-tumbloo-accent focus:ring-tumbloo-accent-light focus:ring-2"
                        >
                        <span class="ml-2 text-sm text-tumbloo-gray">
                            Saya setuju dengan
        ...
        <div class="mt-8 bg-tumbloo-black/50 border border-tumbloo-accent/30 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h4 class="text-sm font-medium text-tumbloo-white mb-1">Data Anda Aman</h4>
                    <p class="text-xs text-tumbloo-gray">
                        Kami menggunakan enkripsi tingkat tinggi untuk melindungi informasi pribadi Anda.
                    </p>
                </div>
            </div>
        </div>

...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/seller/product/create.css') }}">
@endpush
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('seller.products.store') }}" method="POST" id="productForm">
            @csrf
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    @if ($category->children->count() > 0)
                                        @foreach ($category->children as $subcategory)
                                            <option value="{{ $subcategory->id }}" {{ old('product_category_id') == $subcategory->id ? 'selected' : '' }}>
                                                &nbsp;&nbsp;└─ {{ $subcategory->name }}
                                            </option>
                                        @endforeach
                                    @endif
            ...
            <!-- Info Upload Gambar Nanti -->
            <div class="info-box">
                <i class="fas fa-info-circle"></i>
                <div>
                    <strong>Langkah Selanjutnya</strong>
                    <p>Setelah menyimpan produk, Anda akan diarahkan ke halaman upload gambar produk.</p>
                </div>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="fas fa-arrow-right"></i> Simpan & Upload Gambar
                </button>

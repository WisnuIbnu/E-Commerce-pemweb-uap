...
<x-seller-layout>
    ...
    <div class="py-6">
        ...
        <div class="max-w-5xl mx-auto px-4 lg:px-0 space-y-4">
            ...
            {{-- HEADER --}}
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Pembeli: <span class="font-semibold text-gray-700">{{ $order->buyer->user->name ?? '-' }}</span>
                    </p>
                </div>
                ...
                <div class="md:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div class="divide-y divide-gray-100">
                        ...
                        <div class="py-3 flex gap-3">
                            ...
                            @else
                            <div class="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center text-[10px] text-gray-400 flex-shrink-0">
                                No Image
                            </div>
                            @endif
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between gap-2">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">
                                            Qty: {{ $item->qty }} × Rp {{ number_format($item->price ?? 0, 0, ',', '.') }}
                                        </p>
                                    </div>
                                    <p class="text-sm font-semibold text-gray-900">
                                        Rp {{ number_format(($item->qty * ($item->price ?? 0)), 0, ',', '.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="space-y-4">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                        ...
                        <dl class="space-y-2 text-sm">
                            @php
                            // hitung subtotal dari detail pesanan
                        ...
                        <form action="{{ route('seller.orders.update', $order) }}" method="POST" class="space-y-3">
                            ...
                            <div>
                                ...
                                <select name="status"
                                    ...
                                    {{-- SESUAIKAN opsi dengan enum yang kamu pakai --}}

    ...
    <div class="max-w-6xl mx-auto py-10 px-4 space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 bg-white rounded-2xl shadow-sm px-4 py-3">
            <div class="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>Produk di kategori {{ strtolower($category->name) }} siap dikirim dari toko terpercaya.</span>
            </div>
        ...
        {{-- LIST PRODUK --}}
        @if($products->count())
            {{-- GRID & CARD DISAMAKAN PERSIS DENGAN /products --}}
        ...
        @else
            ...
            <div class="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p class="text-sm text-gray-500 max-w-sm">
                    Produk dalam kategori ini belum tersedia. Silakan cek kategori lain atau kembali lagi nanti.
                </p>
            </div>
        @endif
